...
@Component({
    selector: 'app-orders-cards-view',
    standalone: true,
    imports: [
        CommonModule,
        TagModule,
    ...
    templateUrl: './orders-cards-view.component.html',
    styleUrl: './orders-cards-view.component.css'
})
export class OrdersCardsViewComponent {
