...
async function main() {
    ...
    const services = [
        // Servicios para Auto
        { name: 'Lavado Simple (Auto)', category: client_1.VehicleCategory.AUTO, price: 10.00 },
        { name: 'Lavado Premium (Auto)', category: client_1.VehicleCategory.AUTO, price: 15.00 },
        { name: 'Lavado Completo (Auto)', category: client_1.VehicleCategory.AUTO, price: 20.00 },
        // Servicios para SUV
        { name: 'Lavado Simple (SUV)', category: client_1.VehicleCategory.SUV, price: 12.00 },
        { name: 'Lavado Premium (SUV)', category: client_1.VehicleCategory.SUV, price: 18.00 },
        { name: 'Lavado Completo (SUV)', category: client_1.VehicleCategory.SUV, price: 25.00 },
        // Servicios para Moto
        { name: 'Lavado Moto', category: client_1.VehicleCategory.MOTO, price: 8.00 },
        { name: 'Lavado Premium Moto', category: client_1.VehicleCategory.MOTO, price: 12.00 },
        // Servicios para Pickup
        { name: 'Lavado Simple (Pickup)', category: client_1.VehicleCategory.PICKUP, price: 12.00 },
        { name: 'Lavado Premium (Pickup)', category: client_1.VehicleCategory.PICKUP, price: 18.00 },
        // Servicios para Camión
        { name: 'Lavado Simple (Camión)', category: client_1.VehicleCategory.CAMION, price: 15.00 },
        { name: 'Lavado Premium (Camión)', category: client_1.VehicleCategory.CAMION, price: 25.00 },
    ];
    let createdCount = 0;
    let updatedCount = 0;
